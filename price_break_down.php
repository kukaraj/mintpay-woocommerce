...
// method to display single variant product price
...
function mintpay_get_variable_product_installment($variation_data, $product, $variation) {
	...
	if (!in_array(114, $product_category)) return $variation_data; // edit me
	...
	$mintpay_logo = '<img style="position: relative; cursor: pointer; height: ' . $mintpay_logo_height . '; vertical-align: middle; width: auto;" class="mintpay-logo" src="https://static.mintpay.lk/static/base/logo/logo_w120_h32.png" alt="Mintpay">';
...
// display mintpay price breakdown - single and archive pages - only in frontend
if (is_admin() != true) return add_filter('woocommerce_get_price_html', 'mintpay_display_price_breakdown', 9000000, 2);

// single function to calculate monthly installment
